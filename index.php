...
<body>
    ...
    <footer id="footer">
        <div class="grid">
            <div class="row">
                <ul class="footer-genr-list l-2 m-4 c-6">
                    <li>T&ĐFilm</li>
                    <img class="logo-footer" src="./icon/z4250255531215_fe622fd66eddc03705f6e624c17a8f5f.jpg" alt="">
                </ul>
                <ul class="footer-genr-list l-2 m-4 c-6">
                    <li class="footer-genr-list-item"><a href="" class="footer-genr-list-item_link">Fantastic Film</a></li>
                ...
                <ul class="footer-genr-list l-2 m-4 c-6">
                    <li class="footer-genr-list-item"><a href="" class="footer-genr-list-item_link">New Film</a></li>
                ...
                <ul class="footer-genr-list l-2 m-4 c-6">
                    <li class="footer-genr-list-item"><a href="" class="footer-genr-list-item_link">About Us</a></li>
                ...
                <ul class="footer-genr-list l-2 m-4 c-6">
                    <li class="footer-genr-list-item"><a href="" class="footer-genr-list-item_link">Contact With Us</a></li>
                ...
                <ul class="footer-genr-list l-2 m-4 c-6">
                    <li class="footer-genr-list-item"><a href="" class="footer-genr-list-item_link">Information</a></li>
